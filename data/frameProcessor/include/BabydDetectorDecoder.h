...
#define MASK_TO_LOWER_48_BITS(x) ((x) & 0xFFFFFFFFFFFF)
#define MASK_UPPER_16BITS(num) ((uint16_t)(((num) & 0xFFFF000000000000))>>48
...
public:
	...
	//return MASK_TO_LOWER_48_BITS((reinterpret_cast<X10GRawFrameHeader *>(frame_hdr))->frame_number)
    }
    ...
    {
        return MASK_TO_LOWER_48_BITS((reinterpret_cast<X10GPacketHeader *>(packet_hdr))->frame_number);
    }
